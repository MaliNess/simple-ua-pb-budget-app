...
```sh
node --check src/app/budget-config.js
node --check src/app/budget-dom.js
node --check src/core/budget-core.js
node --check src/state/budget-state.js
node --check src/import/budget-import-export.js
node --check src/import/budget-file-actions.js
node --check src/columns/budget-columns.js
node --check src/columns/budget-column-dialogs.js
node --check src/columns/budget-icons.js
node --check src/tickets/budget-tickets.js
node --check src/tickets/budget-expense-dialogs.js
node --check src/tickets/budget-bulk-label-dialogs.js
node --check src/currencies/budget-currencies.js
node --check src/planning/budget-planning.js
node --check src/planning/budget-planning-render.js
node --check src/planning/budget-planning-dialog-core.js
node --check src/planning/budget-planning-list-dialog.js
node --check src/planning/budget-planning-edit-dialog.js
node --check src/planning/budget-planning-match-dialog.js
node --check src/planning/budget-planning-dialogs.js
node --check src/summary/budget-summary.js
node --check src/summary/budget-summary-dialogs.js
node --check src/splits/budget-splits.js
node --check src/app/budget-ui.js
node --check src/columns/budget-mask-actions.js
node --check src/splits/budget-split-dialogs.js
node --check src/board/budget-board-render.js
node --check src/board/budget-board-controller.js
node --check src/app/budget-app-bootstrap.js
node --check src/vendor/xlsx-lite.js
